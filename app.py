...
annual_demand = st.sidebar.number_input("Permintaan Tahunan (D) 📈", min_value=1, value=2000, help="Jumlah total unit yang dibutuhkan dalam setahun.")
...
holding_cost = st.sidebar.number_input("Biaya Penyimpanan (H) (Rp) 🏦", min_value=1, value=5000, help="Biaya untuk menyimpan satu unit barang selama setahun dalam Rupiah.")
